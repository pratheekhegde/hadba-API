...
<form action=loadclass.php method=post>
	<input name=id type=hidden value="Class3B"><input name="" type="submit" value="<?php echo GetClassName("Class3B");?>"></form><br>
<form action=loadclass.php method=post>
	<input name=id type=hidden value="Class3C"><input name="" type="submit" value="<?php echo GetClassName("Class3C");?>"></form><br>
<form action=loadclass.php method=post>
	<input name=id type=hidden value="Class3D"><input name="" type="submit" value="<?php echo GetClassName("Class3D");?>"></form><br>
<form action=loadclass.php method=post>
...
<form action=loadclass.php method=post>
	<input name=id type=hidden value="Class4F"><input name=id type=submit value="<?php echo GetClassName("Class4F");?>"></form><BR>
<form action=loadclass.php method=post>
