...
<form action=submitfeedback.php method=post name=feedback>
...
<tr><td><ol><li>Follows the course handout closely in all respects and completes<br>syllabus in time.</td>
...
<tr><td><ol><li value=2>Uses class time well and takes classes regularly.</li></td>
...
<tr><td><ol><li value=3>Seems well prepared for each class and clearly explains structure,<br>objectives and requirements of the course.</li></td>
...
<tr><td><ol><li value=4>Takes extra class whenever necessary.</li></td>
...
<tr><td><ol><li value=5>Possesses effective communication skills and gives clear<br>explanations.</li></td>
...
<tr><td><ol><li value=6>Has good command over the subject matter and is not confused by<br>unexpected questions.</li></td>
...
<tr><td><ol><li value=7>Stresses important points in lectures, discussions and touches<br>upon the relevant practical field applications.</li></td>
...
<tr><td><ol><li value=8>Is enthusiastic, confident and seems to enjoy teaching.</li></td>
...
<tr><td><ol><li value=9>Is skilful in observing students reactions and understands the<br>students' difficulties with coursework.</li></td>
...
<tr><td><ol><li value=10>Presents subject matter in logical way and makes good use of<br> examples.</li></td>
...
<tr><td><ol><li value=11>Makes proper use of teaching aids (black board/LCD/OHP/models etc.).</li></td>
...
<tr><td><ol><li value=12>Is friendly, flexible and maintains an atmosphere of good feelings in a<br> class.</li></td>
...
<tr><td><ol><li value=13>Acknowledges all questions in a non-threatening way, encourages<br>active participation and stimulates discussion.</li></td>
...
<tr><td><ol><li value=14>Treats students with respect, encourages constructive criticism and<br>motivates them to learn more about the subject.</li></td>
...
<tr><td><ol><li value=15>Is available, accessible and approachable.</li></td>
...
<tr><td><ol><li value=16>Writes legibly and quite audible in the class.</li></td>
...
<tr><td><ol><li value=17>Is fair and objective in assessments of students' work and<br>entertains recheck request from the students.</li></td>
...
<tr><td><ol><li value=18>Suggests specific ways for students to improve and keeps students<br>informed of their progress.</li></td>
...
<tr><td><ol><li value=19>Tries to readjust his teaching technique if the class does't follow him.</li></td>
...
<tr><td><ol><li value=20>The overall learning process in the subject was useful and<br>enjoyable.</li></td>
...
<tr><td colspan=6><b>COMMENTS, if any:</b><br><textarea type="text" name=21 placeholder="(Up to 400 Characters)" maxlength="400" style="width: 760px; height: 100px;"></textarea></td></tr>
</table>
<table width=760><tr><td width=380><hr color=green></td><td><hr color=red></tr>
<tr><td align=left><button><b><font color=green>Submit Feedback</font></b></button></form></td><td align=right rowspan=2><form action=startsession.php name=sublist><button><b>Go Back To Subject Selection Page</b></button></form></td></tr>
<tr><td>&nbsp;</td></tr>
</table>
</center>
</div>